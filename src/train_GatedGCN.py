...
from src.models.GatedGCN import GatedGCN
...
class LitGatedGCNModel(pl.LightningModule):
    def __init__(self, gin_params, training_params):
        super().__init__()
        self.save_hyperparameters()
        self.gnn = GatedGCN(**gin_params)
...
if __name__ == '__main__':
    ...
    model = LitGatedGCNModel(gnn_params, training_params)
