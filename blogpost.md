...
| Experiment Number | Model    | Cellular in model | PE type     | Cellular in PE | Type of Random walk                             | Train acc | Val acc | Test acc   | Best epoch | Command                                                                                                      |
|------------------:|----------|-------------------|-------------|----------------|-------------------------------------------------|-----------|---------|------------|------------|--------------------------------------------------------------------------------------------------------------|
| 1                 | GIN      | No                | None        | -              | None                                            | 0.100     | 0.435   | 0.422900   | 199        | python -m src.train                                                                                          |
| 2                 | GIN      | No                | Random Walk | No             | No                                              | 0.003     | 0.251   | 0.227071   | 499        | python -m src.train --use_pe rw                                                                              |
| 3                 | GIN      | No                | Random Walk | Yes            | Boundary/Co boundary                            | 0.002     | 0.241   | 0.205413   | 499        | python -m src.train --use_pe ccrw --traverse_type boundary                                                   |
| 4                 | GIN      | No                | Random Walk | Yes            | Upper adjacency                                 | 0.003     | 0.246   | 0.220600   | 499        | python -m src.train --model gin --use_pe ccrw --traverse_type upper_adj                                      |
| 5                 | GIN      | No                | Random Walk | Yes            | Lower adjacency                                 | 0.002     | 0.316   | 0.314015   | 499        | python -m src.train --use_pe ccrw --traverse_type lower_adj                                                  |
| 6                 | GIN      | No                | Random Walk | Yes            | Both Upper and lower adjacency                  | 0.004     | 0.303   | 0.257367   | 499        | python -m src.train --model gin --use_pe ccrw --traverse_type upper_lower                                    |
| 7                 | GIN      | No                | Random Walk | Yes            | Boundary/Co boundary, Upper and lower adjacency | 0.002     | 0.259   | 0.218300   | 499        | python -m src.train_GIN --use_pe ccrw --traverse_type upper_lower_boundary                                   |
| 8                 | GIN-LSPE | No                | Random Walk | no             | normal                                          | 0.003     | 0.242   | 0.195422   | 499        | python -m src.train --use_pe rw --learnable_pe True                                                          |
| 9                 | GIN-LSPE | Yes               | Random Walk | Yes            | Upper adjacency                                 | 0.002     | 0.252   | 0.204869   | 499        | python -m src.train --use_pe ccrw --learnable_pe True  --traverse_type upper_adj                             |
| 10                | GIN-LSPE | Yes               | Random Walk | Yes            | Lower adjacency                                 | 0.005     | 0.310   | 0.301796   | 499        | python -m src.train --use_pe ccrw --learnable_pe True  --traverse_type lower_adj                             |
| 11                | GIN-LSPE | Yes               | Random Walk | Yes            | Boundary/Co boundary                            | 0.004     | 0.241   | 0.201649   | 499        | python -m src.train --use_pe ccrw --learnable_pe True  --traverse_type boundary                              |
| 12                | GIN-LSPE | Yes               | Random Walk | Yes            | Both Upper and lower adjacency                  | 0.005     | 0.297   | 0.251322   | 499        | python -m src.train --use_pe ccrw --learnable_pe True  --traverse_type upper_lower                           |
| 13                | GIN-LSPE | Yes               | Random Walk | Yes            | Boundary/Co boundary, Upper and lower adjacency | 0.003     | 0.249   | 0.203753   | 499        | python -m src.train --model gin --use_pe ccrw --learnable_pe True --traverse_type upper_lower_boundary       |
| 14                | GCN      | No                | None        | -              | None                                            | 0.00175   | 0.3118  | 0.281576   | 499        | python  -m src.train --model gated_gcn                                                                       |
| 15                | GCN      | No                | Random Walk | No             | Upper adjacency                                 | 0.003048  | 0.20908 | 0.186355   | 499        | python -m src.train --model gated_gcn --use_pe rw                                                            |
| 16                | GCN      | No                | Random Walk | Yes            | Boundary/Co boundary, Upper and lower adjacency | 0.001823  | 0.20805 | 0.17915397 | 499        | python -m src.train --model gated_gcn --use_pe ccrw --traverse_type upper_lower_boundary                     |
| 17                | GCN      | No                | Random Walk | Yes            | Boundary/Co boundary                            | 0.00425   | 0.189   | 0.1785     | 499        | python -m src.train --model gated_gcn --use_pe ccrw --traverse_type boundary                                 |
| 18                | GCN      | No                | Random Walk | Yes            | Upper adjacency                                 | 0.007     | 0.20148 | 0.18258    | 499        | python -m src.train --model gated_gcn --use_pe ccrw --traverse_type upper_adj                                |
| 19                | GCN-LSPE | No                | Random Walk | No             | Normal                                          | 0.002066  | 0.1563  | 0.134818   | 499        | python -m src.train --model gated_gcn --use_pe rw --learnable_pe True                                        |
| 20                | GCN-LSPE | Yes               | Random Walk | Yes            | Boundary/Co boundary, Upper and lower adjacency | 0.002     | 0.1271  | 0.113833   | 499        | python -m src.train --model gated_gcn --use_pe ccrw --learnable_pe True --traverse_type upper_lower_boundary |
| 21                | GCN-LSPE | Yes               | Random Walk | Yes            | Upper adjacency                                 | 0.003     | 0.153   | 0.125357   | 499        | python -m src.train --model gated_gcn --use_pe ccrw --learnable_pe True --traverse_type upper_adj            |
| 22                | GCN-LSPE | Yes               | Random Walk | Yes            | Lower adjacency                                 | 0.003     | 0.225   | 0.229040   | 499        | python -m src.train --model gated_gcn --use_pe ccrw --learnable_pe True --traverse_type lower_adj            |
| 23                | GCN-LSPE | Yes               | Random Walk | Yes            | Boundary                                        | 0.004     | 0.157   | 0.134979   | 499        | python -m src.train --model gated_gcn --use_pe ccrw --learnable_pe True --traverse_type boundary             |
# Conclusion
