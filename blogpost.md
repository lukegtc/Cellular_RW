...
|    Model |     PE type | Cellular in PE |                             Type of Random walk | Implementation | Train acc | Val acc |   Test acc | Improvement over Vanilla Model | Command                                                                                                      |
|---------:|------------:|---------------:|------------------------------------------------:|---------------:|----------:|--------:|-----------:|-------------------------------:|--------------------------------------------------------------------------------------------------------------|
|      GIN |        None |              - |                                                 |           Done |     0.100 |   0.435 |   0.422900 |                                | python -m src.train                                                                                          |
|      GIN | Random Walk |             No |                                              No |           Done |     0.003 |   0.251 |   0.227071 |                         46.31% | python -m src.train --use_pe rw                                                                              |
|      GIN | Random Walk |            Yes |                            Boundary/Co boundary |           Done |     0.002 |   0.241 |   0.205413 |                         51.43% | python -m src.train --use_pe ccrw --traverse_type boundary                                                   |
|      GIN | Random Walk |            Yes |                                 Upper adjacency |           Done |     0.003 |   0.246 |   0.220600 |                         47.84% | python -m src.train --model gin --use_pe ccrw --traverse_type upper_adj                                      |
|      GIN | Random Walk |            Yes |                                 Lower adjacency |           Done |     0.002 |   0.316 |   0.314015 |                         25.75% | python -m src.train --use_pe ccrw --traverse_type lower_adj                                                  |
|      GIN | Random Walk |            Yes |                  Both Upper and lower adjacency |           Done |     0.004 |   0.303 |   0.257367 |                         39.14% | python -m src.train --model gin --use_pe ccrw --traverse_type upper_lower                                    |
|      GIN | Random Walk |            Yes | Boundary/Co boundary, Upper and lower adjacency |           Done |     0.002 |   0.259 |   0.218300 |                         48.38% | python -m src.train_GIN --use_pe ccrw --traverse_type upper_lower_boundary                                   |
| GIN-LSPE | Random Walk |             no |                                         normal  |           Done |     0.003 |   0.242 |   0.195422 |                                | python -m src.train --use_pe rw --learnable_pe True                                                          |
| GIN-LSPE | Random Walk |            Yes |                                 Upper adjacency |                |     0.002 |   0.252 |   0.204869 |                         -4.83% | python -m src.train --use_pe ccrw --learnable_pe True  --traverse_type upper_adj                             |
| GIN-LSPE | Random Walk |            Yes |                                 Lower adjacency |                |     0.005 |   0.310 |   0.301796 |                        -54.43% | python -m src.train --use_pe ccrw --learnable_pe True  --traverse_type lower_adj                             |
| GIN-LSPE | Random Walk |            Yes |                            Boundary/Co boundary |                |     0.004 |   0.241 |   0.201649 |                         -3.19% | python -m src.train --use_pe ccrw --learnable_pe True  --traverse_type boundary                              |
| GIN-LSPE | Random Walk |            Yes |                  Both Upper and lower adjacency |                |     0.005 |   0.297 |   0.251322 |                        -28.60% | python -m src.train --use_pe ccrw --learnable_pe True  --traverse_type upper_lower                           |
| GIN-LSPE | Random Walk |            Yes | Boundary/Co boundary, Upper and lower adjacency |                |     0.003 |   0.249 |   0.203753 |                         -4.26% | python -m src.train --model gin --use_pe ccrw --learnable_pe True --traverse_type upper_lower_boundary       |
|      GCN |        None |              - |                                            None |           Done |   0.00175 |  0.3118 |   0.281576 |                                | python  -m src.train --model gated_gcn                                                                       |
|      GCN | Random Walk |             No |                                 Upper adjacency |           Done |  0.003048 | 0.20908 |   0.186355 |                         33.82% | python -m src.train --model gated_gcn --use_pe rw                                                            |
|      GCN | Random Walk |            Yes | Boundary/Co boundary, Upper and lower adjacency |           Done |  0.001823 | 0.20805 | 0.17915397 |                         36.37% | python -m src.train --model gated_gcn --use_pe ccrw --traverse_type upper_lower_boundary                     |
|      GCN | Random Walk |            Yes |                            Boundary/Co boundary |                |   0.00425 |   0.189 |     0.1785 |                         36.61% | python -m src.train --model gated_gcn --use_pe ccrw --traverse_type boundary                                 |
|      GCN | Random Walk |            Yes |                                 Upper adjacency |                |     0.007 | 0.20148 |    0.18258 |                         35.16% | python -m src.train --model gated_gcn --use_pe ccrw --traverse_type upper_adj                                |
| GCN-LSPE | Random Walk |             No |                                         Normal  |           Done |  0.002066 |  0.1563 |   0.134818 |                                | python -m src.train --model gated_gcn --use_pe rw --learnable_pe True                                        |
| GCN-LSPE | Random Walk |            Yes | Boundary/Co boundary, Upper and lower adjacency |           Done |     0.002 |  0.1271 |   0.113833 |                         15.57% | python -m src.train --model gated_gcn --use_pe ccrw --learnable_pe True --traverse_type upper_lower_boundary |
| GCN-LSPE | Random Walk |            Yes |                                 Upper adjacency |                |     0.003 |   0.153 |   0.125357 |                          7.02% | python -m src.train --model gated_gcn --use_pe ccrw --learnable_pe True --traverse_type upper_adj            |
| GCN-LSPE | Random Walk |            Yes |                                 Lower adjacency |                |     0.003 |   0.225 |   0.229040 |                        -69.89% | python -m src.train --model gated_gcn --use_pe ccrw --learnable_pe True --traverse_type lower_adj            |
| GCN-LSPE | Random Walk |            Yes |                                        Boundary |                |     0.004 |   0.157 |   0.134979 |                         -0.12% | python -m src.train --model gated_gcn --use_pe ccrw --learnable_pe True --traverse_type boundary             |
# Conclusion
